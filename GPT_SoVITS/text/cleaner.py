...
#     from sovits.GPT_SoVITS.text.symbols import symbols
# else:
#     from sovits.GPT_SoVITS.text import chinese2 as chinese
#     from sovits.GPT_SoVITS.text.symbols2 import symbols
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("sovits.GPT_SoVITS.text." + language_module_map[language], fromlist=[language_module_map[language]])
